...
export default {
    ...
    profile: {
        ...
        giftCardError: '礼品卡兑换失败，请稍后重试',
        giftCardEmpty: '请输入礼品卡代码',
        giftCardSuccessBalance: '兑换成功！已到账余额 {value} 元',
        giftCardSuccessTime: '兑换成功！有效期已延长 {value} 天',
        giftCardSuccessTraffic: '兑换成功！已增加 {value} GB 流量',
        giftCardSuccessReset: '兑换成功！本月流量已重置归零',
        giftCardSuccessPlan: '兑换成功！套餐已激活，有效期 {value} 天',
        giftCardSuccessPlanPermanent: '兑换成功！永久套餐已激活',
        giftCardErrNotExist: '礼品卡不存在，请检查卡号是否正确',
        giftCardErrNotYetValid: '礼品卡尚未生效，请在有效期内使用',
        giftCardErrExpired: '礼品卡已过期，无法兑换',
        giftCardErrLimitReached: '礼品卡使用次数已达上限',
        giftCardErrAlreadyUsed: '您已兑换过此礼品卡，每张仅限使用一次',
        giftCardErrNotSuitable: '礼品卡类型与当前账户状态不匹配',
        giftCardErrUnknownType: '礼品卡类型无效，请联系客服',
        giftCardErrSaveFailed: '兑换时发生错误，请稍后重试',
        saveChanges: '保存更改',
        cancel: '取消',
